        ...
        <CCol>
          <CCard>
            <CCardBody style={{ margin: 'auto' }} >
              <CButton style={{ width: 600, height: 100, fontSize: 50 }} variant='outline' shape='pill' type="submit" color="danger">Apply for Trainer</CButton>{" "}
            </CCardBody>
          </CCard>
        </CCol>
      </CRow >
